...
public class SavingsAccount
{
    ...
    public SavingsAccount(String customerFirstName, String customerLastName, String customerAddress, String customerPhoneNumber, String customerEmailAddress, String stringAccountBalance)
    {
    ...
    {
        customerSavingsAccount = new SavingsAccount(customerFirstName, customerLastName, customerAddress, customerPhoneNumber, customerEmailAddress, stringAccountBalance);
        isUserCustomer = true;
    }
